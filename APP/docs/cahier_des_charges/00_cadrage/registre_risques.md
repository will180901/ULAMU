...
| R-04 | **Médecins peu réactifs** : poignées de main jamais confirmées → patients découragés | Moyen | Élevé | Indicateur « disponible maintenant » ; notifications efficaces côté web ; mise en avant des médecins réactifs dans les résultats |
