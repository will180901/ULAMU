...
| **111** | **Deux retraits demandés par le porteur** — 14/09. ⚠️ **La « pré-consultation » parlait encore sur la fiche du soignant** : une carte « Pré-consultation gratuite » promettait un formulaire retiré au chantier 105. *Une promesse qui survit à la fonctionnalité qu'elle décrivait est un mensonge poli.* 📌 Et le **partage du profil** (bouton natif iOS/Android) est retiré : *« retire les fonctionnalités de partage, peu importe ».* Les deux autres partages du téléphone — export du Carnet par le patient, code de remise familial — **n'ont pas été touchés** : ce sont des transferts de données vers soi ou vers un proche, pas de la vitrine ; question posée au porteur avant d'y toucher. **mobile 116 ✓ · lint propre · types propres.** | ⏸ en attente | ⏸ |
| **112** | **L'export du Carnet retiré du téléphone** — 14/09, décision du porteur, après la question posée au chantier 111 : *« retire l'export du carnet, garde le code familial »*. Le bouton « Exporter mon carnet » et sa mise en forme texte disparaissent. 📌 **La route serveur et son empreinte sha256 restent** : le droit du patient sur ses données ne dépend pas d'un bouton, et le lot PDF signé (EF-07-08) s'y adossera — *ce qui disparaît est le bouton, pas le droit.* La méthode du client API le dit maintenant en toutes lettres : *une méthode que personne n'appelle doit le dire, sinon quelqu'un la croira branchée.* **mobile 116 ✓ · lint propre · types propres.** | ⏸ en attente | ⏸ |
| **113** | **Le carnet de numéros Mobile Money — le serveur** — 14/09, faille signalée par le porteur. ⚠️ **L'ordre de débit partait vers le numéro de CONNEXION**, quel que soit l'opérateur choisi à l'écran : un compte enregistré en Airtel qui cliquait « MTN MoMo » envoyait la demande vers un portefeuille MTN sur un numéro qui n'en a pas. *Un numéro de connexion prouve qui on est ; un numéro Mobile Money reçoit de l'argent — ce n'est pas le même métier, et c'était le même champ.* 📌 Table `MomoNumber` : **un numéro par opérateur et par compte** — *une ambiguïté qu'on ne crée pas est une ambiguïté qu'on n'aura pas à trancher dans l'urgence d'un paiement.* 📌 Le carnet vit dans **M01** et non M13 : l'invariant RM-13-01 interdit à l'Argent de connaître des personnes. 📌 Le préfixe **prévient sans interdire** (portabilité) — *un préfixe qui interdit se trompe le jour où l'opérateur ouvre une tranche.* 📌 Repli volontaire sur le numéro de connexion pour les comptes d'avant : *une fondation ne casse pas ce qui tient déjà dessus.* **API 684 ✓ · types propres.** | ⏸ en attente | ⏸ |
| **114** | **Les écrans du carnet de numéros** — 14/09, suite du 113. Web : un onglet **Mobile Money** dans *Mes paramètres*, placé AVANT les appareils — *ce qu'on vient chercher en panique ne se met pas en quatrième position.* Mobile : un écran **Mobile Money** sous « Changer de numéro », et ce voisinage est le message : *un numéro de connexion prouve qui on est ; un numéro Mobile Money reçoit de l'argent.* 📌 Les deux écrans **annoncent le repli** — sans numéro enregistré, la demande part sur le numéro du compte : *un repli tu est un piège ; un repli annoncé est un choix.* 📌 Et le doute sur le préfixe s'affiche sur le numéro **enregistré**, pas seulement pendant la saisie : *un avertissement qui ne vit que le temps d'un formulaire ne protège que ce jour-là.* **web 1101 ✓ (6 nouveaux) · mobile 116 ✓ · types propres.** | ⏸ en attente | ⏸ |
| **115** | **Le numéro débité, dit avant de payer** — 14/09, suite du carnet. ⚠️ L'écran de paiement demandait l'opérateur et **ne disait jamais sur quel numéro la demande partirait** : elle partait sur le numéro de CONNEXION. *La seule chose que la personne voyait était une demande qui n'arrivait jamais.* 📌 Le numéro s'affiche **sous l'opérateur choisi** — c'est la paire (opérateur, numéro) qui fait la transaction, les séparer laisserait croire que l'un des deux suffit. 📌 Il dit d'OÙ il vient (carnet ou compte), répète le doute sur le préfixe *au dernier moment où il peut encore servir*, et offre le raccourci vers le carnet. > **Ce qui se voit avant de payer ne se découvre pas après.** **mobile 121 ✓ (5 nouveaux) · types propres · lint propre.** | ⏸ en attente | ⏸ |
| **116** | **Trois demandes du porteur, d'un coup** — 14/09. ① **Le partage retiré partout** : restait un carré sur la carte du soignant. ⚠️ **Et « Voir le profil » n'était pas un bouton** — un `View` posé dans la carte, sans appui, sans retour visuel, sans libellé pour un lecteur d'écran : *un objet qui a l'air d'un bouton et qui n'en est pas déplace la faute sur celui qui appuie — il croit avoir mal visé.* ② **La règle du numéro** (9 chiffres, commençant par 0), **vendorée** dans les trois copies : champs chiffres uniquement, message qui dit CE QUI MANQUE — *« numéro invalide » n'apprend rien à qui ne sait pas s'il manque un chiffre ou si le premier est faux.* *Une règle connue des deux côtés se dit à la frappe ; une règle connue d'un seul côté se dit en retard.* ③ **Les logos MTN et Airtel** (Wikimedia, domaine public + marque) remplacent l'icône grise : *une marque se reconnaît à sa couleur avant de se lire.* Usage NOMINATIF documenté dans `OPERATEURS.md`. **web 1101 ✓ · mobile 121 ✓ · vendorage ✓ · types propres.** | ⏸ en attente | ⏸ |
| **117** | **Le numéro de retrait se prouve, et il attend** — 14/09. ⚠️ **Les gains partaient vers le numéro de CONNEXION**, et rien ne prouvait que ce numéro fût un portefeuille tenu par le titulaire. 📌 *Sur un paiement, un numéro faux donne une demande qui n'arrive pas ; sur un RETRAIT, il envoie l'argent à un inconnu — et il ne revient pas.* > **Un numéro qui reçoit de l'argent doit être prouvé ; un numéro qui en envoie se prouve tout seul**, puisque son titulaire confirme sur son téléphone. 📌 Code SMS envoyé **au numéro lui-même** (usage OTP dédié `MOMO_VERIFY` — le quota se compte par usage, un code de retrait qui mangerait celui d'une action sensible enfermerait quelqu'un dehors au pire moment). 📌 **PM-41 : 24 h d'attente après un changement** — *il ne protège pas d'une erreur, il protège d'un vol, et ne coûte qu'au cas le plus rare et le plus suspect.* 📌 L'état de la preuve se lit **sur la ligne** : *dire à quoi un numéro sert déjà, et à quoi il ne sert pas encore, évite de le croire cassé.* ⚠️ **Migration à appliquer au déploiement** (nouvelle valeur d'énumération + PM-41). **API 684 ✓ · web 1106 ✓ · mobile 121 ✓ · types propres.** | ⏸ en attente | ⏸ |
| **118** | **Le prix se fige à la demande** — 14/09. ⚠️ **Le montant était relu dans l'offre au moment de PAYER.** Entre la demande et le paiement il se passe plusieurs minutes — le soignant confirme, le patient sort son téléphone — et la vitrine invite le soignant à ajuster ses tarifs quand il veut, **sans rien lui dire des demandes en cours**. *Le défaut se déclenchait donc au moment où quelqu'un fait exactement ce que l'application l'invite à faire.* > **Un prix montré est un engagement ; le relire plus tard, c'est se réserver le droit d'en changer.** 📌 Le libellé et la durée sont figés aussi : *un reçu qui suit sa source n'est plus une trace.* 📌 Colonne NULLABLE pour les poignées d'avant, qui retombent sur l'offre vivante : *une colonne NOT NULL qu'on remplit d'un zéro inventé ment mieux qu'une colonne vide.* ⚠️ **Migration à appliquer au déploiement** (trois colonnes + rattrapage des poignées existantes). **API 687 ✓ · types propres.** | ⏸ en attente | ⏸ |
| **119** | **La plateforme relevée — une colonne oubliée l'avait mise à terre** — 15/09. ⚠️ **L'API n'a plus démarré pendant trois heures**, et le chantier 118 n'est jamais arrivé en ligne. La migration du 117 insérait PM-41 sans `updatedAt` — colonne `NOT NULL` **sans valeur par défaut**, parce que `@updatedAt` est tenu par le CLIENT Prisma et jamais par la base. La contrainte a sauté, la transaction a été annulée, la migration s'est inscrite `failed`, et **P3009 a dès lors bloqué TOUTES les suivantes**. > **Une colonne qu'un outil remplit toujours pour vous finit par passer pour une colonne qui se remplit toute seule.** 📌 La faute ne casse rien en local — personne n'y rejoue les migrations à la main : *elle ne se manifeste qu'au démarrage, en production, quand il est déjà trop tard.* 📌 Les quatre migrations précédentes qui ajoutaient une valeur d'énumération avaient toutes cette instruction **en dernier** : le 117 est le premier à écrire quelque chose après, donc le premier à insérer une ligne. ⚠️ **La remise en marche demande un geste du porteur sur la base** (`prisma migrate resolve --rolled-back`) : une migration marquée en échec ne se rejoue pas toute seule. Livré : le SQL corrigé (rejouable — `IF NOT EXISTS` + `ON CONFLICT DO NOTHING` étaient déjà là) et le filet `migrations-insert-colonnes.spec.ts`, qui relit le SQL des migrations et refuse tout `INSERT` omettant une colonne obligatoire. **API 689 ✓ (687 + 2) · types propres · 2 fautes injectées, 2 attrapées.** | ⏸ en attente | ⏸ |
| **120** | **Le patient choisit son offre** — 15/09, demande du porteur (« lorsqu'on paie, on paie une seule fois. Or le patient doit être libre de choisir l'offre pour la consultation »). ⚠️ **Le téléphone prenait la première offre STANDARD et l'imposait** : un soignant peut en publier cinq (PM-25), l'annuaire les servait toutes depuis toujours, et **aucun écran n'en montrait plus d'une** — *onzième occurrence du motif : une capacité existe côté serveur, aucun écran n'offre de chemin pour l'atteindre.* > **Choisir à la place de quelqu'un ce qu'il va payer, c'est décider pour lui de ce dont il a besoin.** 📌 **La case cochée d'office est la MOINS CHÈRE**, et le tri ne se délègue pas au serveur : *un défaut qui pousse vers la dépense n'est pas un défaut, c'est une vente.* 📌 **Une seule offre → pas de case à cocher** : *un interrupteur qui ne change rien est pire qu'un interrupteur absent.* 📌 **Ce qui se vend séparé de ce qui est inclus** — une seule liste « Tarifs » portait la consultation qu'on achète, le suivi qu'on n'achète pas ici et l'ordonnance gratuite : *ce qui porte un prix dans une même colonne se lit comme ce qu'on peut choisir.* ⚠️ **Le suivi reste annoncé, hors du choix** (le chantier 65 avait déjà réparé une fois qu'il se vendait comme une première consultation) — le taire laisserait croire qu'un second rendez-vous se repaie plein tarif. 📌 Le prix du bas suit la case cochée, et c'est cet `offerId` qui part : le serveur le fige ensuite (118), donc **ce qui est lu est ce qui sera payé, et ce que le reçu portera**. ✅ **Dette n°30 ouverte ici, CLOSE le jour même par le chantier 121** : `cheapestOffer` de la LISTE était calculée tous types confondus — un soignant dont le suivi est moins cher affiche le prix du suivi comme prix d'appel. Sonde `scripts/offres-visibles.ts` (lecture seule) ajoutée pour le mesurer.  ⚠️ **Corrigé après mesure EN LIGNE le 15/09** : le seul soignant de l'annuaire n'a qu'une offre active, et le titre « Choisissez votre consultation » se serait affiché au-dessus d'une ligne unique et non cochable — *inviter à choisir là où il n'y a rien à choisir fait chercher une option qui n'existe pas.* Le titre ne devient une invitation qu'à partir de deux offres. **mobile 132 ✓ (121 + 11) · types propres · lint 0 erreur (aucun avertissement nouveau) · 8 fautes injectées, 8 attrapées.** | ⏸ en attente | ⏸ |
| **121** | **Ce que le serveur servait, et que personne ne voyait** — 15/09, demande du porteur (« il y a un truc qui manque … je veux un truc irréprochable »), après qu'il a publié une offre de suivi et vu la carte changer. ⚠️ **La carte de l'annuaire annonçait 15 min et 3 000 XAF** — les chiffres du SUIVI — pour une consultation de 30 min à 5 000 XAF : `cheapestOffer` était calculée tous types confondus. C'est le défaut du chantier 65, resté sur l'écran que tout le monde voit en premier. > **Un prix d'appel qu'on ne peut pas payer n'est pas un prix, c'est un appât.** 📌 Et la même valeur portait le **tri par prix** et le **filtre « prix maximum »** : *corriger l'affichage sans corriger le filtre aurait déplacé le mensonge au lieu de le retirer.* ⚠️ **Et le PRIX était absent de la carte**, alors que CU-05-01 l'exige mot pour mot — une règle de maquette (« les tarifs n'apparaissent que sur la fiche ») l'avait emporté sur le cahier des charges : comparer trois soignants demandait six navigations. 📌 « À partir de » n'apparaît que s'il y a vraiment plusieurs consultations — nouveau champ serveur `consultationCount`. ⚠️ **Trois données exigées par le cahier des charges, servies par l'API depuis toujours, affichées NULLE PART** — **12ᵉ occurrence du motif** : la **biographie** (EF-05-01 ; le modèle de vue la portait, aucun écran ne la montrait), le **taux de confirmation** (EF-05-01 : *le délai dit en combien de temps il répond, le taux dit S'IL répond*) et les **avis** — répartition + commentaires (EF-05-07), que le modèle de vue ne portait même pas. Armel Konaté avait une biographie écrite et deux avis de vrais patients ; personne ne pouvait les lire. 📌 La répartition et pas seulement la moyenne : *« 3,5 » né de deux avis moyens n'est pas « 3,5 » né d'un enthousiasme et d'un désastre.* 📌 **L'échelle des notes se lit dans les CLÉS servies par le serveur** (PM-13), jamais écrite en dur — le projet a déjà payé ce motif sur les « 12 % » et les « 48 h ». ⚠️ **La première injection n'a attrapé que 5 fautes sur 9** : rien ne retenait le prix de la carte, la biographie, le taux ni le compte d'offres — *une donnée qu'on vient d'ajouter est exactement celle que la prochaine refonte retirera sans le savoir.* Quatre filets ajoutés, puis **9 / 9**. **API 696 ✓ (689 + 7) · mobile 150 ✓ (132 + 18) · types propres · lint 0 erreur · 171 routes · 11 fautes injectées, 11 attrapées.** | ⏸ en attente | ⏸ |
| **122** | **Un titre ne nomme jamais ce que quelqu'un d'autre nomme** — 15/09, **trouvé par le porteur** (« imagine que le médecin crée une offre avec un nom différent de consultation … c'est incohérent »). ⚠️ Le titre de section disait « Consultation » / « Choisissez votre consultation », et la carte « la consultation ». Ce mot vient du **type** de l'offre côté serveur ; le **nom**, lui, est écrit librement par le soignant (120 caractères). Une offre nommée « Bilan santé » donnait « CONSULTATION / Bilan santé » — un titre et un nom qui ne se répondent pas. > **Un titre qui nomme la chose entre en concurrence avec celui qui la nomme vraiment ; un titre qui décrit ce qu'on fait ne peut contredire personne.** 📌 Recopier le libellé dans le titre ne marchait pas non plus : *avec deux offres, quel nom prendrait le titre ?* ⚠️ **Écarté : « réserver » et « rendez-vous »** — ULAMU n'a ni créneau ni agenda, et le soignant peut refuser : *un mot qui promet un horaire, ou qui fait croire que c'est acquis, ment avant même que l'écran suivant s'ouvre.* Les titres suivent désormais la voix des autres sections — **« ce qu'il dit de sa pratique » · « ce qu'il propose » · « à vous de choisir » (dès deux offres) · « ce que disent ses patients »**. 📌 Sous le prix de la carte, **« tout compris »** remplace le mot de catégorie : c'est exact (D-010, prix final commission incluse) et aucun libellé ne peut le contredire — *quand on ne peut pas nommer, on peut encore garantir.* ⚠️ Une ancre du filet changée **en conscience** : ce qu'elle défend n'a pas bougé, sa formulation a cessé de nommer. 📌 Le filet a mordu tout de suite — l'apostrophe typographique étant normalisée par le harnais, le motif devait s'écrire `['’]`. **mobile 152 ✓ (150 + 2) · types propres · lint 0 erreur · vérifié écran en main.** | ⏸ en attente | ⏸ |
| **123** | **Les avis se parcourent enfin — le serveur** — 15/09, question du porteur (« supposant qu'on atteint une grande audience, comment les avis vont s'afficher ? »). ⚠️ La réponse honnête était : **dix, toujours les dix mêmes**. La fiche servait `latestComments` — dix derniers, sans curseur, sans tri, sans filtre, sans dire qu'il y en avait d'autres : un soignant à 400 avis en montrait 10, les 390 autres étaient inaccessibles à jamais. > **Une moyenne sans ses avis est un chiffre qu'on doit croire sur parole.** `GET /v1/directory/:id/reviews` : curseur, tri (récents · meilleurs · moins bons), filtre par note, total. 📌 `sessionId` ferme chaque tri — *un curseur n'a de sens que sur un ordre total*. 📌 Les notes SANS commentaire restent dans la liste : *« 400 avis » en haut et 120 lignes en dessous se lit comme une dissimulation.* ⚠️ **Aucun identifiant de patient ne sort**, décision du porteur prise en connaissance de cause : « Mireille a consulté le Dr X » est une information médicale sur une personne identifiable. À la place, la **fidélité** — *quelqu'un qui revient est le signal le plus fort qui existe, et il ne nomme personne* ; le `patientId` la calcule et ne franchit jamais la frontière HTTP. ⚠️ **Deux fautes injectées sont passées sous le filet, et la cause était MON BOUCHON** : il triait de façon stable là où PostgreSQL ne garantit rien, et ignorait le filtre qu'on venait d'ajouter — *un bouchon plus gentil que la base ne teste pas le code, il teste le bouchon.* Durci (mélange dont la graine change à chaque requête : *un désordre qui se répète à l'identique n'est plus un désordre*), puis **6 / 6**. **API 706 ✓ (696 + 10) · types propres · lint 0 · 172 routes.** | ⏸ en attente | ⏸ |
| **124** | **Tous les avis, et les barres qui deviennent des boutons** — 15/09. L'écran `Avis` ouvre ce que le chantier 123 a rendu servable : défilement infini, tri, et **filtre par note en touchant une barre de la répartition**. 📌 *La seule question qu'on se pose vraiment devant une moyenne est « qu'est-ce qui s'est mal passé chez les mécontents ? »*, et presque aucune plateforme ne la rend facile — le visuel que le porteur avait retenu de la fiche devient le chemin. 📌 La fiche n'en montre plus que **trois**, et dit combien il y en a : *un extrait qui ne dit pas qu'il est un extrait se fait passer pour le tout.* 📌 Le pied annonce toujours « N affichés sur T » puis « tous les avis sont affichés » : *un total qu'on affiche sans dire ce qu'on en montre est la moitié d'une information.* 📌 **« Patient revenu 3 fois chez ce soignant »** à la place du nom, « Avis vérifié · consultation payée » à la première. ⚠️ Un échec de page suivante ne jette pas ce qui est déjà lu, et la suite ne se demande qu'une fois à la fois — *sans ce garde, un défilement rapide affiche deux fois les mêmes avis.* 📌 La répartition et la moyenne **voyagent avec la navigation** : les redemander ferait clignoter des chiffres déjà lus. **mobile 159 ✓ (152 + 7) · types propres · lint 0 erreur.** | ⏸ en attente | ⏸ |
| **125** | **Le tarif de suivi ferme sa porte** — 15/09, demande du porteur. ⚠️ **`initiate()` acceptait n'importe quelle offre ACTIVE, `FOLLOW_UP` comprise.** Les écrans ne la proposaient plus depuis longtemps — chantier 65 sur la fiche, chantier 120 dans le choix — mais un simple appel HTTP avec l'`offerId` du suivi vendait toujours une PREMIÈRE consultation au tarif réduit, et cet identifiant n'a rien de secret : **l'annuaire le sert publiquement**. > **Une règle que seul l'écran applique n'est pas une règle : c'est une convention entre gens bien élevés.** *Deux chantiers avaient déjà réparé le symptôme côté écran ; celui-ci ferme la porte.* 📌 La condition s'écrit telle que le produit la pense : le suivi est le tarif de quelqu'un qu'on suit DÉJÀ, donc **une consultation antérieure avec CE professionnel**. 📌 **Et pour la MÊME personne soignée** (`subProfileId`) : *ce n'est pas le payeur qu'on suit, c'est le patient* — sans cela, un parent ayant consulté pour lui-même ouvrait le tarif réduit à la première consultation de son enfant, le défaut déplacé d'un cran. 📌 **Aucun statut de séance exigé** : une session existe dès le paiement (chantier 108) — *quelqu'un qui a payé une consultation chez ce soignant est déjà son patient, même si la séance s'est mal passée ensuite*, et lui refuser le tarif réduit punirait la victime de la défaillance. **API 712 ✓ (706 + 6) · types propres · lint 0 · 172 routes · 3 fautes injectées, 3 attrapées.** | ⏸ en attente | ⏸ |
| **126** | **Le reçu dit ce qui a été acheté** — 15/09, demande du porteur. ⚠️ Le reçu affichait « Consultation », un mot **deviné par l'écran** depuis la référence d'ordre (`handshake:…`) — alors que le soignant nomme son offre librement : *quelqu'un qui avait payé « Bilan santé 60 min » recevait un reçu disant « Consultation ».* Le chantier 118 avait pourtant déjà figé `offerLabel` sur la poignée ; il n'atteignait simplement jamais le reçu. > **Un reçu est une trace : il doit dire ce qui a été acheté, pas la catégorie dans laquelle on le range.** 📌 **Une COLONNE (`Payment.label`), pas une jointure à l'affichage** : relire la poignée rebrancherait le reçu sur une source vivante — ce que le 118 a précisément défait — et ferait dépendre M13, **aveugle au métier par construction** (RM-13-01), du module des consultations. M13 range le texte et le ressort : il n'en déduit rien. 📌 **NULLABLE**, avec rattrapage des paiements existants depuis `Handshake.offerLabel` (les deux formes de référence, dont celle des nouvelles tentatives) ; l'écran retombe sur son ancienne déduction quand il n'y a rien — *mieux vaut une catégorie honnête qu'un nom inventé.* ⚠️ **2 fautes sur 5 sont passées sous le filet à la première injection**, dont **la régression exacte du 118** : rien n'empêchait M06 de relire l'offre VIVANTE au lieu du libellé figé. Deux ancres de source ajoutées — *un test faible sur une règle que rien ne gardait vaut mieux qu'un test parfait qu'on n'écrit pas* — puis **5 / 5**. ⚠️ **Migration à appliquer au déploiement** (une colonne + rattrapage ; aucun INSERT, le filet du 119 le vérifie). **API 717 ✓ (712 + 5) · mobile 164 ✓ (159 + 5) · types propres · lint 0 erreur · 172 routes.** | ⏸ en attente | ⏸ |
| **127** | **« On attend » et « c'est décidé » ne sont pas le même état** — 15/09, **reprise de la passe 1 (médecin)**. ⚠️ **Mesuré EN LIGNE sur le compte d'Armel, dossier VÉRIFIÉ** : « Ma vérification » disait, sur la même hauteur d'écran, « Vérifié · vous pouvez exercer » **ET** « le dossier est en cours d'examen » **ET** quatre pièces « À déposer » **ET** « vous serez prévenu dès qu'une décision est prise ». Armel exerce pourtant : il est dans l'annuaire et a reçu des consultations payées. > **Un écran qui ne sait pas dire où en est votre dossier est pire qu'un écran laid.** 📌 **La donnée était juste** : l'écran ne lisait qu'un seul signal, `documentsEditable`, **faux pour deux raisons opposées** — *le dossier est entre les mains d'un vérificateur*, ou *la décision est déjà tombée*. **Un même symptôme pour deux causes contraires ne peut pas produire une phrase juste.** 📌 « À déposer » est une CONSIGNE : quand le dépôt est fermé, elle devient « Non fournie » — *une consigne qu'on ne peut pas suivre n'est pas une consigne, c'est un reproche.* 📌 Le délai d'attente cède la place à l'historique quand la décision est prise : *ce qui s'est passé reste, ce qui va se passer, non.* ⚠️ **Piège évité en chemin** : masquer la carte de la file d'attente emportait « Écrire à l'administration », **seul chemin vers le support** depuis cet écran et le plus utile après un refus — *masquer une explication périmée ne doit pas emporter le bouton qui l'accompagnait.* La carte reste, son contenu s'adapte. ⚠️ **Deux tests gardaient le défaut** : ils montaient un dossier VÉRIFIÉ et exigeaient la file d'attente — *un test posé sur le mauvais état ne prouve pas la règle, il fige l'endroit où elle est fausse.* Remis sur un dossier en examen, plus deux cas neufs. 📌 **Mesures de l'écran, prises en ligne** : 51 textes, **82 % entre 9 et 14 px**, plus grand caractère 26 px — la platitude que le porteur décrit (« sans vie ») est mesurable ; contrastes sains (1 seul écart, la pastille de cloche à 9 px, réservée au chantier de la coque). **web 1108 ✓ (1106 + 2) · types propres · 164 promesses, 124 retenues.** | ⏸ en attente | ⏸ |
| **128** | **La coque : sept liens qui ne disaient pas où ils mènent** — 15/09, passe 1. ⚠️ **Mesuré dans l'arbre d'accessibilité du site en ligne** : les **sept** liens de navigation s'annonçaient `link`, sans plus. L'icône porte `aria-hidden`, le libellé n'existe que déployé, et l'infobulle Radix ne nomme le lien que pendant qu'elle est ouverte : **au repos, la navigation principale était muette pour un lecteur d'écran**. > **Un lien sans nom n'est pas un lien.** 📌 Les boutons voisins étaient déjà nommés (« Notifications : 24 non lues », « Ma présence : En ligne ») : *ce n'était pas une négligence, c'était un trou — et un trou ne se voit que si on va mesurer.* ⚠️ **Le test de coquille expliquait lui-même pourquoi il n'interrogeait que les `href`** (« au repos la barre n'affiche que les icônes ») : la raison était juste, et c'est elle qui a laissé le trou — *tester l'accès sans tester le nom, c'est vérifier qu'une porte existe sans regarder si elle est signalée.* 📌 **Le survol n'existe pas au doigt** : une tablette de 800 px passe la bascule mobile de 768 px, donc était traitée comme un ordinateur — sept icônes muettes, sans moyen de les nommer. `useSansSurvol()` interroge `(hover: none)`, soit l'APPAREIL et non la largeur : *ce n'est pas la taille de l'écran qui empêche de survoler, c'est le doigt.* 📌 **Pastille de compteur** : dernier écart de contraste connu du produit (blanc à **4,36** en sombre, seuil 4,5), signé dès le 09/09. ⚠️ **La passation se trompait sur le remède** — elle annonçait « agrandir la pastille (15 → 16 px) », or le seuil ne s'assouplit qu'à 24 px (18,7 px en gras) : *un seuil qu'on croit franchir en grossissant ne bouge pas d'un pouce.* Et `--erreur-accent` ne pouvait pas être assombri, il sert aux BORDURES des champs en erreur : *deux usages qui demandent des directions opposées ont besoin de deux jetons.* Nouveau `--pastille-compteur` — **6,36 en clair, 5,49 en sombre**. **web 1113 ✓ (1108 + 5) · types propres · 4 fautes injectées, 4 attrapées.** | ⏸ en attente | ⏸ |
| **129** | **B3 — un intitulé qui a la taille de son explication ne s'annonce plus** — 15/09, passe 1. ⚠️ **Mesuré en ligne sur « Mes paramètres »** : l'intitulé de ce qu'on règle (« Thème », « Densité », « Sons de l'interface ») s'écrivait à **13 px**, son explication à **12 px** — **un pixel d'écart**. Sur cet écran, **21 textes partageaient la même taille** : le sous-titre de page, les six onglets et chaque intitulé. *L'œil n'avait aucun point d'entrée — c'est cela, très précisément, qu'on décrit en disant « sans vie ».* 📌 **Un RÔLE manquait à la fondation**, et c'est le seul cas où elle s'étend (règle du chantier 70) : `--voix-intitule` + `.ul-intitule`, pendant exact de `--voix-chiffre-ligne` — là la valeur devait dominer son intitulé, ici l'intitulé doit dominer son aide. **15 px en soin, 13 px en administration**, avec graisse ET encre primaire : *à un seul pixel d'écart, aucune des trois marques ne suffisait.* 📌 Le composant partagé `Reglage` le porte — **8 écrans redressés d'un coup** — plus 6 recopies dans les sections de B3. ⚠️ **Constat corrigé en cours de route** : j'avais comparé le titre de B3 (24 px) aux 32 px du tableau de bord pour conclure qu'il était trop petit. **Faux** — les 32 px sont un CHIFFRE HÉROS, et B3 n'a aucun chiffre à montrer ; son titre était conforme. *Comparer deux écrans sans comparer leurs rôles fait corriger ce qui allait bien.* ⚠️ **Une faute sur cinq est passée sous le filet** : on pouvait remettre le pixel en dur dans `Reglage` sans qu'un test tombe — la charte vérifiait que le rôle EXISTE, personne ne vérifiait qu'on s'en sert. *Une voix qu'on définit et que les écrans ignorent est une décision qui n'a pas eu lieu.* Filet d'usage ajouté, puis **5 / 5**. 📌 L'administration en est **volontairement exclue** (13 recopies, passe 2 non commencée) : *un filet qu'on tend trop large se coupe pour passer, et ne retient plus rien.* **web 1118 ✓ (1113 + 5) · types propres · lint 0 erreur.** | ⏸ en attente | ⏸ |
| **130** | **Un seul plafond de fichier, et un type validé partout** — 15/09, **demande du porteur** (« il n'y a pas de contrôle de fichier de taille et de type »). 📌 **Première réponse : les contrôles EXISTAIENT** — écran (5 Mo, PDF/images, refusé avant l'envoi), `StorageService` en point de passage unique (liste blanche, refus des exécutables, 8 Mo, chiffré au repos), M01 et M06 validés au contrat, et un bouton « retirer ». *Si le porteur ne pouvait ni ajouter ni retirer, c'est que son dossier est VÉRIFIÉ : les pièces d'un dossier décidé sont figées (chantier 127).* ⚠️ **Mais il y avait TROIS plafonds pour une seule règle** : 5 Mo à l'écran, ~8 Mo au contrat, 8 Mo au stockage — un diplôme de 6 Mo était refusé par l'écran alors que le serveur l'aurait pris, et le message faisait réduire le fichier pour rien. > **Trois chiffres pour une même règle finissent par faire trois règles.** 📌 `packages/shared/src/fichier.ts`, **vendoré** (4ᵉ module de la table) : un plafond, une liste blanche, un message — miroir du serveur, posé côté client pour refuser AVANT l'envoi. ⚠️ **Et le test a trouvé un QUATRIÈME chiffre** que je n'avais pas vu : le contrat bornait le base64 à 11 000 000 caractères, quand il en faut **11 184 812** pour transporter 8 Mo — **le plafond effectif était donc 7,87 Mo**, annoncé nulle part. *Un plafond dérivé d'un autre par un calcul qu'on fait de tête finit par ne plus lui correspondre.* 📌 **M03 validait le type en texte libre**, seul des trois modules : *deux modules qui appliquent une règle et un troisième qui s'en remet au suivant, c'est la règle qui finira par diverger.* ⚠️ **Piège du vendorage** : ma source est partie en CRLF alors que les trois modules existants sont en **LF** — le filet l'a vu tout de suite, *c'est la copie que j'accusais qui avait raison.* **API 721 ✓ (717 + 4) · web 1120 ✓ · mobile 164 ✓ · types propres · 5 fautes injectées, 5 attrapées.** | ⏸ en attente | ⏸ |
| **131** | **Le gabarit d'impression, et l'ordonnance sur papier** — 15/09, **demande du porteur** (« crée un template pour imprimer les documents … comme le projet CMS »). ⚠️ **ULAMU n'imprimait RIEN** : pas un `window.print`, pas un `@media print`, pas un `@page` dans tout le projet web — alors que l'ordonnance se présente EN PHARMACIE, que le reçu sert à un remboursement, que le carnet suit un patient qui change de médecin, et que **le contrat signé se téléchargeait en `.txt`**. > **Un document qu'on ne peut pas sortir de l'écran n'est pas un document : c'est un affichage.** 📌 **Zéro dépendance** — CSS `@media print` + PDF natif du navigateur, le choix de CMS-SARIS après étude de son `MedicalPrintSheet` : *sur une connexion congolaise, faire télécharger une bibliothèque de génération PDF avant d'imprimer une ordonnance est une mauvaise affaire.* 📌 **UNE feuille pour les quatre documents** (en-tête, blocs d'identité, corps, pied) : *quatre gabarits séparés divergeraient en trois mois.* 📌 **Écarté de CMS** : les cadres « signature et cachet » — personne ne signe cette feuille à la main, la preuve est électronique. *Un cadre vide sur un document médical invite à le remplir après coup.* ⚠️ **Le premier jet a réintroduit un mensonge déjà corrigé** : il appelait le QR « code de délivrance » et promettait qu'« une pharmacie le scanne » — **exactement la phrase retirée de l'écran au chantier 27** (ULAMU n'est relié à aucune officine). C'est un SCEAU d'intégrité. > **Une phrase fausse retirée d'un écran revient par le document qu'on imprime, si personne ne la garde des deux côtés.** 📌 L'état invalidant (annulée, périmée) se lit **en tête et en grand**, et le sceau disparaît alors : *ce qui invalide un document doit se lire avant son contenu.* ⚠️ **Une faute sur sept est passée sous le filet** : on pouvait retirer `@page { size: A4 }` — la règle qui décide du format du papier — sans qu'un test tombe. *Un document dont on garde le texte mais pas la mise en page finit par sortir juste… sur un format que personne n'a demandé.* Filet de mécanique ajouté, puis **7 / 7**. **web 1134 ✓ (1120 + 14) · types propres · lint 0 erreur.** | ⏸ en attente | ⏸ |
| **132** | **Le contrat et le reçu prennent la même feuille** — 15/09. ⚠️ **Le contrat signé se téléchargeait en `.txt`** : un document juridique en texte brut, sans en-tête, sans date de signature, et **sans l'empreinte qui prouve qu'il s'agit du texte accepté** — elle existait pourtant en base, personne ne la montrait. > **Un contrat qu'on ne peut pas présenter n'engage personne à vos yeux, même s'il vous engage en droit.** 📌 Le document porte désormais l'**empreinte entière** (une empreinte tronquée ne prouve rien), la date et l'heure de signature, le signataire, et **la commission en tête** — *ce qu'on relit doit se trouver sans être cherché*. 📌 Le corps s'imprime **tel qu'il a été signé** : *reformater un contrat, c'est en changer la lecture, et l'empreinte à côté ne correspondrait plus.* 📌 **Le reçu** porte le libellé FIGÉ (chaîne des chantiers 118 et 126), le total en grand, et répète la garantie donnée avant de payer : *une garantie donnée avant l'acte doit se retrouver sur la preuve de l'acte.* ⚠️ Un **remboursement** s'imprime comme un remboursement — le mot ET le signe changent : *le présenter comme une dépense fausserait une note de frais.* 📌 **Redondance retirée en chemin** : le numéro de reçu figurait trois fois (en-tête, corps, pied) — *deux fois la même information n'est pas deux fois plus sûre, c'est une ligne de moins pour ce qui manque.* ⚠️ **Deux fautes sur huit sont passées sous le filet** : on pouvait reformater le corps du contrat, et le faire repartir en `.txt`. Les cas éprouvaient ce que les documents AFFICHENT, personne ne gardait comment ils sont PRODUITS. ⚠️ Et la seconde est repassée une fois de plus : mon ancre `<ContratImprimable` acceptait aussi `<ContratImprimableAutreChose` — *une ancre qui accepte un préfixe ne garde pas un nom, elle garde un début de nom.* Resserrée, puis **8 / 8**. 📌 **Une ancre du filet changée en conscience** : le test du contrat exigeait un bouton « Télécharger » — ce qu'il défend n'a pas bougé, seule la façon de sortir le contrat a changé. **web 1145 ✓ (1134 + 11) · types propres · lint 0 erreur.** | ⏸ en attente | ⏸ |
| **133** | **Le contrat dit enfin ce qu'il doit dire** — 15/09, **demande du porteur** (« il ne faut pas un contrat bâclé »). ⚠️ **Le texte que les soignants signaient contenait une clause FAUSSE** : un « Article 4 » sur le stock des pharmacies, alors que la chaîne du médicament a été retirée du produit (D-052) et les structures aussi (D-051) — *on faisait signer à des médecins un engagement sur une fonctionnalité qui n'existe plus.* Et il était **muet sur sept points**, dont **la responsabilité de l'acte médical** — la clause la plus importante d'un contrat de soin et la seule qui compte le jour d'un litige — la **résiliation par le praticien** (*un contrat où une seule partie peut sortir n'est pas un contrat, c'est une adhésion*), les **données de santé**, le **versement des gains**, le **remboursement automatique** (*une règle qui décide de votre rémunération doit figurer au contrat qui la fonde, pas seulement dans le code qui l'applique*), la **loi applicable** et la **durée**. ⚠️ **PIÈGE MAJEUR découvert en voulant corriger** : le texte n'est pas stocké, il est **régénéré à chaque lecture puis comparé à l'empreinte scellée** — modifier la fonction aurait fait basculer **tous les contrats déjà signés** en « intégrité rompue », et leur titulaire ne les aurait plus vus, sans avoir rien fait. > **Une empreinte qui protège un texte protège aussi la faute qu'il contient : on ne peut plus le corriger sans détruire les preuves de ceux qui l'ont signé.** 📌 D'où `AgreementVersion.template` (migration nullable) et **deux modèles** : l'origine **figée à l'octet près**, avec sa faute — *on ne corrige pas un contrat déjà signé, on en émet un nouveau* — et le modèle **2026-09**. L'archive est garde par une empreinte **vérifiée contre `git show HEAD:`**, ligne à ligne. 📌 Aucun délai ni montant écrit en dur : *un contrat qui recopie un chiffre réglable ment le jour où l'administration le change.* ⚠️ **Deux fautes sur huit sont passées sous le filet, et c'étaient les deux plus graves** : régénérer un contrat signé avec le modèle COURANT (casse tout), et ignorer le changement de modèle à l'émission — *une correction de contrat que personne n'est invité à signer n'a corrigé aucun contrat.* Ancrées dans la source, puis **8 / 8**. ⚠️ **Migration à appliquer** ; **tous les soignants devront re-signer** (décision du porteur, prise en connaissance de cause). **API 737 ✓ (721 + 16) · types propres · lint 0 · 172 routes.** | ⏸ en attente | ⏸ |
| **134** | **Le gabarit devient un acte** — 15/09, **demande du porteur** (« le template est pas mal, mais pas à mon goût … ça doit ressembler à un modèle propre et style digne d'une grande entreprise … le texte doit avoir une police différente et justifié … ordonne les choses »). ⚠️ **Le gabarit du 131 imprimait comme une page web** : marges de 10 mm, une seule police pour tout, texte au fil de l'eau, coins arrondis. *Un document officiel se reconnaît avant d'être lu — à ses marges, à sa typographie, à la façon dont ses blocs tiennent ensemble.* 📌 **Marges de 22 mm** : la marge d'un acte, celle qui laisse la place à une reliure, à un tampon, à une annotation — *un texte qui touche le bord de la feuille se lit comme un tract.* 📌 **Deux familles, deux rôles** : titres en sans-serif de marque, **corps en SERIF**. Ce n'est pas une préférence : sur papier, une serif se lit plus vite sur de longs blocs, et c'est la convention de tout acte écrit — *une police dit à quel genre de document on a affaire avant qu'on en ait lu un mot.* 📌 **Le contrat s'imprime en articles justifiés** : le texte arrive en lignes coupées à largeur fixe, rendues telles quelles elles donnaient un bloc en escalier. Les réunir en paragraphes est de la PRÉSENTATION — *lire le même texte dans une autre police ne le réécrit pas ; réunir deux lignes qu'un retour forcé avait séparées non plus.* ⚠️ **Et c'est exactement la limite à ne pas franchir.** Mon premier jet recomposait « ARTICLE 1 — OBJET » en « Article 1 » + « OBJET » : une transformation de CASSE sur un texte scellé par une empreinte. *Une empreinte ne fait pas la différence entre une faute de frappe et une jolie mise en forme : elle ne voit que des octets qui ont changé.* Corrigé — l'en-tête est rendu tel quel, et le filet ne dit plus « aucun `replace` » (une façon indirecte d'interdire la mise en page) mais **la suite des mots rendus doit être identique, mot pour mot, à celle du texte signé**. 📌 **Un analyseur qui jette ce qu'il ne reconnaît pas fait disparaître des clauses** : préambule et clôture sont gardés, et les deux modèles de rédaction (origine et 2026-09) sont couverts. ⚠️ **J'ai écrit dans l'en-tête une pagination « Page 1 sur N » que le pied n'imprime pas.** Elle n'est pas atteignable sans boîtes de marge `@page` ni bibliothèque de pagination — que la règle « zéro dépendance » écarte. *Un commentaire qui annonce une pagination inexistante est plus dangereux que l'absence de pagination : il empêche de la remarquer.* La limite est écrite, et un filet d'exclusion mutuelle exige désormais **ou le compteur, ou le démenti, jamais les deux ni aucun**. 📌 **Ordonnance et reçu ramenés au gabarit** : trois recopies de police dans l'ordonnance, dont deux nommaient « Inter » — *qui n'est même pas la police de titrage des documents* — et deux `'monospace'` dans le reçu. *Une typographie recopiée dans un coin ne suit pas le gabarit : le jour où il change, ce coin-là reste en arrière, et deux documents d'ULAMU cessent de se ressembler.* ⚠️ **Trois fautes sur huit sont passées sous le filet, et toutes du même côté** : on pouvait repasser le corps en sans-serif, ramener les marges à celles d'une page web, et retirer la règle qui empêche un article de se couper en deux. *Les filets gardaient ce que les documents DISENT ; aucun ne gardait ce à quoi ils RESSEMBLENT.* Sept filets ajoutés — police à replis, marge minimale, règles de saut de page, blocs qui les portent réellement (*une règle CSS que rien ne déclenche est une intention, pas un comportement*), interdiction de recopier une police, accord entre ce que le fichier dit et ce qu'il fait — puis **12 / 12**. ⚠️ **Première écriture du filet de pagination tombée sur elle-même** : elle interdisait les mots « Page 1 sur N » et a attrapé le démenti, qui les cite pour expliquer leur absence — *un filet qui cherche des mots ne distingue pas une promesse d'un aveu.* **web 1156 ✓ (1145 + 11) · types propres · 12 fautes injectées, 12 attrapées.** | ⏸ en attente | ⏸ |
| **135** | **On signait un contrat sans l'avoir lu** — 16/09, **demande du porteur** (« cette rigueur applique pour type de document qu'on va avoir dans ce projet »), sur l'écran où tous les soignants vont re-signer après le chantier 133. ⚠️ **Le texte s'affichait dans un `<pre>` gris de 11 px, haut de 288 px, replié derrière un bouton « Lire le contrat » — et le bouton de signature s'activait que cette boîte ait été ouverte ou non.** On pouvait s'engager sur onze articles sans en avoir vu un seul. > **Un texte qu'on présente en petit, en gris et replié n'est pas présenté : il est rangé.** 📌 **Le contrat à signer est déployé, et la signature se trouve en bas.** Pas de case « j'ai lu », pas de détection de défilement : *la preuve qu'on a lu, c'est qu'on a dû passer devant.* Une fois signé, il se replie — *un contrat qu'on doit signer se déplie, un contrat signé se range.* 📌 **Le découpage quitte le composant d'impression pour `lib/contrat.ts`** : l'écran et le papier lisent le même texte de la même façon, donc **le filet mot-pour-mot les garde tous les deux** — *deux lectures d'un même texte scellé font une lecture gardée et une lecture livrée à elle-même.* 📌 **Sommaire à partir de quatre articles**, intitulés rendus tels qu'ils sont écrits : *ce qu'on relira — la commission, la résiliation, la responsabilité — doit se trouver sans être cherché* ; *un sommaire de deux lignes est du décor.* ⚠️ **Le contrat ne pouvait pas sortir avant d'être signé** — le bouton d'impression n'apparaissait qu'une fois l'engagement pris. *Demander une signature sans laisser emporter le texte, c'est demander de signer sur place.* Le tirage non signé porte désormais un bandeau « PROJET DE CONTRAT — NON SIGNÉ », un autre nom de document, une autre mention de pied et un bloc de preuve adapté : > **Un projet de contrat qui s'imprime comme un contrat signé est un faux que personne n'a voulu fabriquer.** L'empreinte y figure quand même — *une preuve ne sert pas qu'après coup, elle sert aussi à comparer avant.* ⚠️ **« Décision : VERIFIED »** — l'historique recopiait le mot-clé de la base : un médecin de Brazzaville lisait l'anglais d'un schéma Prisma dans la colonne de son propre dossier. > **Un mot que le produit n'a jamais traduit est un mot que le produit n'a jamais lu.** Cinq libellés français, et **un filet qui va lire les valeurs LÀ OÙ LE SERVEUR LES ÉCRIT** (`schema.prisma`) : le jour où une sixième apparaît, il tombe — *une recopie ne suit pas sa source.* ⚠️ **L'empreinte était tronquée à l'écran** (« a3f9…c210 ») alors que la feuille imprimée affirme qu'« une empreinte tronquée ne prouve rien » — et c'est justement en comparant les deux qu'on vérifie qu'elles portent le même texte. *Deux versions d'une même preuve, c'est une preuve de moins.* 📌 **Le bouton disait ce qu'il faisait, et ce qui manquait** : « Continuer » envoyait un code à usage unique sans prévenir, et quatre conditions grisaient « Signer » dont une seule était expliquée — *un bouton gris sans raison se lit comme une panne, et on recharge la page.* 📌 **« dossier 3F8A2C10 »** : l'identifiant technique dit maintenant à quoi il sert et se sélectionne d'un clic — *un numéro montré à quelqu'un qui n'a personne à qui le donner n'est pas une information, c'est un reste de machine.* ⚠️ **Écarté : la serif à l'écran.** CG-02 §01 ferme le référentiel à trois familles ; la serif est une police de PAPIER. *La rigueur d'un acte ne tient pas à sa police : elle tient à ses articles numérotés, à son sommaire, à ses paragraphes justifiés et à l'air entre ses lignes.* 📌 **Quatre ancres changées EN CONSCIENCE**, dont une qui GARDAIT un trou : le cas « le bouton dit ce qu'on regagne en signant » vérifiait… un autre bouton, et se serait tu si celui qu'il annonce avait disparu — *un cas qui s'arrête avant ce qu'il prétend vérifier passe même quand la chose n'existe plus.* ⚠️ **Le filet écran a d’abord mal lu** : comparé sur le `textContent` de la racine, « … OBJET » suivi de « La Plateforme » devenait le mot « OBJETLa ». *Un filet qui lit mal compte des pertes qui n'existent pas — et finirait par être désarmé pour avoir crié à tort.* Lu bloc par bloc. **web 1170 ✓ (1156 + 14) · types propres · lint 0 erreur (aucun avertissement nouveau) · 13 fautes injectées, 13 attrapées du premier coup.** | ⏸ en attente | ⏸ |
| **136** | **Le contrat corrigé n'aurait été proposé à PERSONNE** — 16/09, trouvé en vérifiant, avant de dire au porteur de déployer, **par quel geste le contrat du chantier 133 arriverait jusqu'à Armel Konaté**. ⚠️ **La seule voie est le bouton « rééditer » de l'écran d'administration — et cet écran ne recevait que les TAUX.** Le contrat d'Armel étant déjà au taux courant, la carte affichait « ce contrat est déjà au taux courant, il n'y a rien à rééditer » et **retirait le bouton** — alors que le service, lui, savait parfaitement qu'il fallait rééditer : sa condition d'idempotence tient compte du modèle depuis le chantier 133. > **Une correction de contrat que personne n'est invité à signer n'a corrigé aucun contrat.** C'est le piège du 133 **remonté d'un étage** : la règle avait été corrigée dans le service, pas dans ce qui l'appelle. *Une règle juste dans un service que rien n'appelle n'est pas une règle : c'est une intention.* Et : *une décision prise sur une partie des faits n'est pas une décision prudente, c'est une décision aveugle qui a l'air informée.* 📌 `getCaseForAdmin` sert désormais `agreementTemplate` et `currentTemplate` ; la carte compare **les deux raisons de rééditer**, montre la rédaction du contrat à côté de son taux — *ce qui décide d'un geste doit se voir à l'endroit où on le décide* — et dit **ce qui a changé avant de dire ce que ça coûte** : *un avertissement sans son motif se lit comme une formalité.* 📌 `null` se lit « Rédaction d'origine », jamais « — » : *écrire un tiret là où il y a une réponse ferait croire à une donnée manquante, et on ne réédite pas un contrat pour une donnée manquante.* ⚠️ **Limite écrite et assumée** : un changement de MODÈLE n'a **aucune voie de masse** — la réédition en lot ne se déclenche que sur un changement de PM-01 (`m16.parameters.service.ts`), et elle ne prend que les dossiers déjà SIGNÉS. Avec un seul soignant en production, c'est un clic ; à deux cents, ce sera deux cents. *La limite est écrite plutôt que tue : une limite qu'on documente se remarque, une limite qu'on tait se découvre au mauvais moment.* 📌 **Ancre élargie en conscience** : « n'offre aucun bouton quand le contrat est déjà au taux courant » gardait précisément le défaut — elle exigeait l'absence du bouton dans le cas même où il aurait fallu l'afficher. **API 738 ✓ (737 + 1) · web 1174 ✓ (1170 + 4) · types propres · lint 0 · 7 fautes injectées, 7 attrapées.** | ⏸ en attente | ⏸ |
| **137** | **L'écran neuf face au serveur d'avant** — 16/09, **trouvé en vérifiant le déploiement du 136 EN LIGNE**. ⚠️ **Le site était déjà à jour, l'API non** : ses phrases nouvelles étaient dans le paquet servi (vérifié en cherchant mes propres libellés dans le bundle), tandis que `/health` répondait `startedAt` 03:45:36Z — **23 minutes avant le commit**. *Le web et l'API ne se déploient pas ensemble : il y a toujours une fenêtre où l'écran neuf parle au serveur d'hier, et elle se rouvre à chaque retour arrière du serveur.* 📌 Pendant cette fenêtre, `agreementTemplate` et `currentTemplate` manquent de la réponse, et **`Modèle ${undefined}` se serait écrit en toutes lettres sur l'écran d'un administrateur**. > **Un écran qui affiche « undefined » a l'air cassé ; un écran qui invente une réponse est pire.** L'écran se tait donc sur ce que le serveur ne dit pas — les deux lignes disparaîssent — et continue d'offrir la réédition sur ce qu'il dit encore, le taux : *ce que le serveur dit encore reste dit, seul l'inconnu se tait.* ⚠️ **Une clause défensive retirée après injection.** Mon premier jet écrivait `memeTexte = !texteServi || …` au nom du principe « le doute ne penche pas du côté du geste coûteux ». **La faute injectée est passée sous le filet — et elle avait raison de passer** : quand le serveur se tait, les deux champs valent `undefined`, donc ils sont égaux, donc la comparaison suffisait déjà. Aucun scénario n'atteignait la garde, les deux champs venant de la même réponse. *Du code défensif que rien ne peut déclencher ne protège de rien : il fait seulement croire qu'on est protégé.* Code mort retiré, faute reformulée pour être atteignable, puis **3 / 3**. ✅ **Vérifié en ligne après coup** : API redémarrée à 04:11:31Z, soit après le commit — donc `prisma migrate deploy` est passé (il précède `node` dans `start:prod`, un échec empêcherait le démarrage), et la colonne `AgreementVersion.template` du chantier 133 est en base. Site servi sans une seule requête en erreur. **web 1177 ✓ (1174 + 3) · types propres · lint 0 · 3 fautes injectées, 3 attrapées.** | ⏸ en attente | ⏸ |
| **138** | **« Où je trouve ce code ? »** — 16/09, **question du porteur**, bloqué devant l'écran de signature d'Armel. ⚠️ **Aucun SMS ne quitte ce déploiement.** La seule passerelle branchée est celle de développement : elle journalise le message et n'appelle aucun opérateur. Le code de signature partait donc **dans les journaux du serveur et nulle part ailleurs** — et l'écran disait « un code vient de vous être envoyé » sans dire OÙ. *On ne cherche pas dans une boîte dont on ignore l'existence.* Pendant la recherche, l'annuaire est resté vide. ⚠️ **Et le constat existait DÉJÀ dans le code** : `requestCloseOtp` l'écrivait noir sur blanc et avait été corrigé pour ça, le 07/09. Mais il n'avait été tiré qu'à UN endroit. > **Un correctif appliqué à un seul appelant n'est pas un correctif, c'est une exception.** 📌 **La décision « par où part un code » est écrite une fois** (`requestOtpToOwner`) et les trois appelants la traversent : signature de contrat, clôture de compte, changement de numéro. 📌 **Pas de repli SMS.** Retomber sur un canal qui n'arrive nulle part fait croire qu'un code est parti et laisse quelqu'un l'attendre — c'est exactement ce qui venait de coûter une matinée. Le refus porte le geste à faire : *un code envoyé nulle part est pire qu'un refus qui dit comment s'en sortir.* Le repli SMS de la clôture, né comme une précaution, est retiré pour la même raison. 📌 **La réponse dit à QUELLE adresse**, masquée, et les deux écrans l'affichent. ⚠️ **Changer de numéro était IMPOSSIBLE** : deux SMS exigés, aucun n'arrivant — et l'écran annonçait cette double preuve comme une garantie. Un seul code désormais, à l'email du compte, qui reste la parade contre une session volée (T-01). **Décision du porteur, validée le 16/09 : le nouveau numéro n'est plus prouvé, il est déclaré** — et l'écran le dit : *taire ce qu'on ne vérifie pas laisse croire qu'on le vérifie.* ⚠️ **Ce qui garde le SMS, et pourquoi on ne l'a PAS converti** : `MOMO_VERIFY` prouve qu'on tient la ligne Mobile Money **qui reçoit l'argent**. *Un code envoyé ailleurs qu'à la ligne qu'il prétend prouver ne prouve rien.* Conséquence assumée et écrite : **vérifier un numéro de retrait est impossible tant qu'aucune passerelle SMS réelle n'existe** — à porter au bureau du porteur. 📌 **2FA à la connexion : inchangée** (décision du porteur) — elle passe déjà par email, et TOTP reste le moyen recommandé : *exiger une application d'authentification au Congo est une barrière réelle.* **API 743 ✓ (738 + 5) · web 1181 ✓ · types propres · lint 0 · 9 fautes injectées, 9 attrapées.** | ⏸ en attente | ⏸ |
| **139** | **L'écran disait à un médecin de surveiller la mauvaise ligne** — 16/09, **demande du porteur** (« ce numéro sert juste à titre d'information personnel »). ⚠️ Le bloc « Numéro de téléphone » annonçait « C'est sur ce numéro que partent vos retraits », puis « Vos gains sont virés sur ce numéro. S'il change et que vous ne le mettez pas à jour ici, les virements partiront vers une ligne que vous ne contrôlez plus. » **C'était vrai au chantier 67 ; ça ne l'est plus depuis le chantier 117** (14/09) : les retraits partent d'un `MomoNumber` vérifié, par opérateur, jamais de `Account.phone`. Le service le dit lui-même — *un numéro qui reçoit de l'argent doit être prouvé ; un numéro qui en envoie se prouve tout seul.* > **Un écran qui dit à un médecin que tenir CE numéro à jour protège son argent le détourne de l'endroit où son argent se règle vraiment.** ⚠️ **Et DEUX filets gardaient le mensonge** : un cas nommé « affiche le numéro du compte et **dit que les retraits y partent** », et une promesse du filet de refonte exigeant la phrase « gains sont virés sur ce numéro ». *Une promesse qu'on garde après qu'elle a cessé d'être vraie n'est plus une promesse : c'est un mensonge sous surveillance* — et il aurait été défendu contre quiconque aurait voulu le corriger. Les deux sont repris, et exigent désormais l'inverse. 📌 Le bloc dit ce qu'il est — « votre numéro de contact, l'administration peut vous y joindre » — **et renvoie là où l'argent se règle** : *corriger une phrase fausse sans montrer la vraie porte laisse la personne au même endroit.* 📌 `masquerTelephone` retirée, son dernier appelant ayant disparu : *une fonction gardée « au cas où » devient une piste morte que quelqu'un suivra un jour.* **web 1181 ✓ (1177 + 4) · types propres · lint 0 · injecté avec le 138.** | ⏸ en attente | ⏸ |
| **140** | **Un code à six chiffres se saisit en cases — partout** — 16/09, **demande du porteur** (« je veux aussi que les champs du code soient en cases, comme pour les applications des pros »). ⚠️ **Ce n'était pas une nouveauté à inventer.** La connexion, l'inscription, le mot de passe oublié, l'activation TOTP et le recours affichaient **déjà** six cases séparées ; la signature du contrat, le changement d'adresse, le changement de numéro, le retrait d'argent, la clôture de compte et la vérification Mobile Money saisissaient le même code dans une boîte ordinaire. Le composant existait, le paquet était installé, cinq écrans s'en servaient. > **C'était une incohérence à l'intérieur du produit, pas une fonctionnalité manquante.** *Une capacité qui n'est branchée qu'à la moitié des écrans se lit, depuis l'autre moitié, comme une capacité absente* — **13ᵉ occurrence du motif**. 📌 **Huit saisies converties, et les cinq recopies ramenées à un champ commun** (`ChampCode`) : le même bloc de huit lignes était écrit cinq fois à l'identique. *Une valeur recopiée est une valeur qui dérive ; un bloc recopié, c'est la même chose en plus grand.* Treize écrans, une seule définition. 📌 **Et ce n'est pas qu'une question d'apparence** : six cases disent combien de chiffres sont attendus, montrent où l'on en est, et recadrent un code collé depuis un email. ⚠️ **La règle qui protège autre chose que l'œil** : `onComplete` valide dès le sixième chiffre. Sur une connexion ou une inscription, c'est un clic gagné et l'on recommence si l'on se trompe. Sur une **signature de contrat**, un **retrait d'argent**, une **clôture de compte** ou le **numéro qui reçoit l'argent**, cela retire la seconde pendant laquelle on se ravise. > **Un geste qu'on ne peut pas défaire ne se déclenche pas à la sixième frappe.** Un filet le tient écran par écran. ⚠️ **Défaut d'accessibilité découvert en chemin** : `Libelle` est un `<span>`, pas un `<label>` — les champs de code de la connexion, de l'inscription, du mot de passe oublié et du TOTP n'avaient donc **aucun nom accessible**. *Un champ qu'un lecteur d'écran ne sait pas nommer n'est pas un champ, c'est un obstacle.* Cinq `aria-label` posés, et un filet exige désormais que chaque champ porte un `id` désigné ou un `aria-label`. ⚠️ **Un de mes filets a attrapé mon propre commentaire** : il cherchait `onComplete` et est tombé sur la phrase qui explique pourquoi il n'y en a pas. Resserré sur `onComplete={` — *un filet qui lit la prose comme du code accuse celui qui a pris la peine d'expliquer.* **web 1185 ✓ (1181 + 4) · types propres · lint 0 · 5 fautes injectées, 5 attrapées.** | ⏸ en attente | ⏸ |
| **141** | **La feuille ne connaissait pas la notion de PAGE** — 16/09, **demande du porteur** (« tellement le contrat est long ça ne tient pas sur une page A4, ça déborde … l'idéal c'est une pagination dynamique »). ⚠️ **Mesuré EN LIGNE sur le contrat d'Armel Konaté** : **452 mm** de contenu dans une feuille de **297**. Il dépassait de **155 mm — plus d'une demi-page**. Et l'aperçu ne le montrait même pas : la feuille restait bloquée à sa hauteur et **écrasait** le reste. > **Un aperçu qui ment sur ce qui va sortir est pire qu'une absence d'aperçu.** 📌 **La pagination mesurée** : le gabarit rend le corps une première fois, invisible, à la largeur exacte d'une page ; il mesure chaque bloc, puis les répartit dans autant de feuilles A4 que nécessaire — chacune avec son en-tête, son pied et « Page 2 sur 4 ». **La largeur ne bouge jamais**, et c'est ce qui rend la mesure fiable : *une page web se re-mesure à chaque redimensionnement, une feuille A4 non.* 📌 **L'écran devient identique au papier** — c'est le vrai correctif : la plainte ne portait pas sur le tirage, elle portait sur l'aperçu. 📌 **En-tête complet sur chaque page**, décision du porteur prise en connaissance du coût : environ 6 cm de texte utile en moins par page à partir de la deuxième. *Une page qui se présente seule vaut le papier qu'elle coûte.* ⚠️ **Deux pièges du banc de mesure, tous deux gardés.** Le laisser DANS `#idRacine` ferait sortir le document **en double sur le papier** (la règle d'impression rend visible tout ce qui s'y trouve) ; le laisser monté après la mesure le ferait exister deux fois dans la page, lu deux fois par un lecteur d'écran — c'est d'ailleurs ce qui a fait tomber treize cas au premier jet. *Un instrument de mesure qu'on oublie de ranger devient une pièce du bâtiment.* 📌 **Sans mesure exploitable, tout tient sur une feuille** — jsdom rend zéro partout, un onglet en arrière-plan peut refuser de mesurer : *un aperçu vide par prudence est un aperçu cassé ; mieux vaut une page trop longue qu'une page blanche.* 📌 **La répartition sort du composant** (`lib/pagination-a4.ts`) : *on éprouve ce qui se calcule, et on ancre ce qui se mesure.* ⚠️ **Ancre du 134 reprise EN CONSCIENCE** : elle exigeait « ou le compteur `counter(page)`, ou le démenti », la pagination paraissant alors hors d'atteinte sans bibliothèque. **Elle l'était par cette voie-là ; elle ne l'était pas par la mesure.** *Une impossibilité constatée sur un seul chemin n'est pas une impossibilité : c'est un chemin fermé.* Le cas exige désormais la chose elle-même, et le démenti est parti avec la limite qu'il décrivait. ⚠️ **Une faute est passée sous le filet, et elle était de la pire espèce** : perdre un bloc lorsqu'une page est EXACTEMENT pleine. Mes sept cas écrits à la main ne produisaient jamais ce moment. *Un filet qui n'éprouve que les cas auxquels on a pensé ne garde que contre les fautes auxquelles on a pensé.* Balayage déterministe de 300 tirages ajouté — graine fixe, *un filet qui échoue une fois sur dix n'est pas un filet, c'est une superstition* — puis **6 / 6**. ⚠️ **Limite écrite** : la répartition se fait au BLOC. Un bloc plus haut qu'une page prend sa page et déborde plutôt que de disparaître — *un débordement se voit et se corrige ; une disparition, non.* Le jour où une ordonnance de trente lignes le produira, c'est le tableau qu'il faudra apprendre à couper. ⚠️ **Non vérifié sur papier** : l'aperçu d'impression du navigateur n'est pas atteignable d'ici. La pagination à l'écran est éprouvée ; le tirage reste à confirmer d'un Ctrl+P. 6 mm de marge de sécurité par page absorbent l'écart écran/imprimante. **web 1194 ✓ (1185 + 9) · types propres · lint 0 · 6 fautes injectées, 6 attrapées.** | ⏸ en attente | ⏸ |
| **142** | **32 mm de texte étaient coupés, et rien ne le disait** — 16/09, **trouvé en vérifiant le déploiement du 141**, que le porteur avait pourtant validé (« le découpage tombe juste »). ⚠️ **Mesuré en production** : la répartition budgétait **185 mm** de blocs sur la première page, et ces blocs en occupaient **224**. Écart de **39 mm**, dont 32 rognés en silence par le `overflow: hidden` de la feuille. La cause : `getBoundingClientRect()` rend la hauteur d'un élément **sans ses marges**, et un article en porte 13 px — dix articles, quarante millimètres. > **Mesurer un bloc sans l'espace qu'il pousse devant lui, c'est mesurer un meuble sans compter qu'on doit ouvrir sa porte.** 📌 `display: flow-root` sur chaque bloc du banc : les marges de l'enfant y sont enfermées, et la hauteur mesurée devient la place réellement occupée. 📌 `minHeight: 0` sur le corps : un élément flexible refuse par défaut de descendre sous la hauteur de son contenu — sans cela, un corps trop plein **pousse** la feuille au lieu d'être contenu par elle, et le débordement se produit sous le tapis. ⚠️ **Leçon sur la vérification** : « le découpage tombe juste » était vrai à l'œil — deux pages numérotées, rien d'anormal à voir. *Un défaut qui se cache derrière un `overflow: hidden` ne se voit pas : il se mesure.* **web 1194 ✓ · types propres · lint 0.** | ⏸ en attente | ⏸ |
| **143** | **« Est-ce réellement dynamique pour TOUT document ? » — la réponse était non** — 16/09, **question du porteur**. ⚠️ La répartition du 141 se faisait au BLOC, et **le tableau des médicaments d'une ordonnance était un seul bloc** : au-delà d'une douzaine de lignes, il dépassait la page et se faisait rogner. *Sur une ordonnance, une ligne rognée est un médicament qui disparaît.* La limite était écrite au 141 ; l'écrire ne la corrigeait pas. > **Un tableau qu'on ne sait pas couper est un tableau qu'on finit par couper n'importe où.** 📌 **`GroupeImprimable`** : un marqueur que la feuille lit parmi ses enfants — il ne rend jamais rien lui-même, *un composant qui se rendrait tout seul empêcherait justement ce qu'on lui demande, être coupé.* Chaque ligne devient paginable, et **l'en-tête est réimprimé** en haut de la page où le tableau reprend : *une colonne de chiffres sans son titre n'est plus une colonne, c'est une liste de nombres.* Le coût de cet en-tête est **payé à chaque reprise**, dans la répartition. 📌 **`tableLayout: 'fixed'`**, et ce n'est pas une préférence : en largeur automatique, chaque page calculerait ses colonnes sur les seules lignes qu'elle porte — *un tableau dont les colonnes bougent d'une page à l'autre ne se lit plus comme un tableau.* ⚠️ **Trois fautes sur sept sont passées sous le filet, et DEUX pour la même raison que le chantier 140** : mes filets relisaient **mes propres commentaires**. Le commentaire qui EXPLIQUE une décision contient les mots de cette décision, et le filet se déclarait satisfait alors que le code avait disparu. > **Un filet qui lit la prose comme du code accuse celui qui a pris la peine d'expliquer, et absout celui qui a retiré la règle.** Corrigé deux fois à la main avant de comprendre qu'il fallait corriger la CAUSE : `sansCommentaires()` est désormais posé une fois pour toutes — *une faute qu'on répare au cas par cas revient sous un autre nom.* ⚠️ **Et la troisième était un cas trop facile** : éprouver l'en-tête répété sur trois lignes de 10 le laissait tenir sur une page malgré la faute. *Un cas trop facile ne vérifie que la patience de celui qui l'a écrit.* Puis **7 / 7**. **web 1203 ✓ (1194 + 9) · types propres · lint 0 · 7 fautes injectées, 7 attrapées.** | ⏸ en attente | ⏸ |
| **144** | **On signe au bas de ce qu'on a lu — et on le dit** — 16/09, **demande du porteur** (« tellement ça défile à cause de la longueur … je veux un truc du genre des parties pliables », « sans oublier d'ajouter la mention lu et approuvé », « pour le sommaire je ne pense pas que ce soit nécessaire »). ⚠️ **La carte faisait 2 230 px de haut.** Le chantier 135 avait déplié le contrat pour qu'on ne puisse plus signer sans l'avoir vu ; déplié, il ne se lisait plus. 📌 **Écarté, et pour une raison** : replier les onze articles réglerait le défilement, mais permettrait de cocher « lu et approuvé » sans avoir ouvert un seul tiroir — *c'est-à-dire exactement la boîte repliée que le 135 avait retirée, sous un autre nom.* > **Un contrat qu'on replie pour le confort du lecteur redevient un contrat qu'on ne lit pas.** 📌 **Une zone de lecture à hauteur fixe** règle les deux d'un seul geste : la page ne défile plus sans fin, et **arriver en bas devient la preuve de lecture** qui déverrouille la mention. *Le confort et la preuve tirent enfin dans le même sens.* 📌 **Barre de progression et « Article 5 sur 11 »** à la place du sommaire, écarté par le porteur : *un sommaire dit où l'on POURRAIT aller, une position dit où l'on EST* — et c'est la seconde qui manque quand on lit un texte long dans une fenêtre courte. 📌 **« Lu et approuvé »** : la case reste hors d'atteinte tant que le bas du texte n'est pas atteint, avec la raison écrite, et elle commande le bouton de signature. *Une mention qu'on peut cocher sans avoir lu n'est pas une mention, c'est une case de plus.* ⚠️ **« 10 % » barré à côté de « 10 % »**, vu par le porteur sur son écran. Une réédition peut ne porter que sur le TEXTE (chantiers 133 et 136) : *barrer un chiffre qui n'a pas changé annonce une modification qui n'existe pas, et cache celle qui existe.* La comparaison ne s'affiche plus que si le taux diffère ; sinon une phrase dit ce qui a vraiment changé. 📌 **Quatre composants étaient installés et branchés nulle part** — `accordion`, `collapsible`, `scroll-area`, `progress` : zéro écran. **14ᵉ occurrence** du motif *une capacité qui n'est branchée nulle part se lit comme une capacité absente.* ⚠️ **Une faute est passée sous le filet, et c'est une limite assumée** : sous jsdom la zone de lecture n'a aucune hauteur, elle est donc « lue » dès l'affichage — retirer le verrou ne change rien d'observable. *Une règle que le banc d'essai ne peut pas atteindre s'ancre dans la source, ou elle ne se garde pas du tout.* Ancrée, commentaires retirés avant la recherche, puis **8 / 8**. 📌 **Ancre remplacée en conscience** : le cas qui exigeait un sommaire garde désormais la progression — ce qu'il défendait n'a pas changé. **web 1207 ✓ (1203 + 4) · types propres · lint 0 · 8 fautes injectées, 8 attrapées.** | ⏸ en attente | ⏸ |
| **145** | **Le contrat devient un acte, pas une fiche** — 16/09, **demande du porteur** (« je veux que le contrat ressemble à un truc créé et écrit par un expert du domaine administratif, et non un truc qui donne l'impression que c'est écrit par l'IA »). ⚠️ **Il avait raison, et quatre choses trahissaient la machine.** 📌 **Un chiffre en vitrine** : « CE QUE LA PLATEFORME RETIENT · 10 % » en 27 px dans un encadré — *c'est un tableau de bord, pas un acte.* Retiré, et **le composant ne reçoit même plus le taux** : *une donnée qu'un composant ne reçoit pas est une donnée qu'il ne peut pas remettre en vitrine six mois plus tard.* La rémunération est à l'article 5, où le porteur l'a demandée. 📌 **L'information dite deux fois** : les cases « Praticien / Nom / Signé le » et « Contrat / Version » répétaient ce que le préambule dit déjà en toutes lettres. *Un acte ne pose pas une fiche technique au-dessus de son propre préambule.* 📌 **Une référence de machine en haut à droite** (« CTR-V2 »), descendue en pied. 📌 **Rien à la fin.** Le document se terminait sur un encadré posé au milieu de nulle part. Il porte désormais sa **clôture** : le procédé, **la date de signature**, le bloc du praticien, puis l'empreinte entière. > **Un acte ne s'ouvre pas sur son numéro de série et ne se termine pas sur le résumé de sa fiche.** 📌 **Nouveau modèle `2026-09.2`** : « Version 2 — modèle 2026-09 » était **dans le texte scellé**, première ligne — l'ôter demandait un modèle. Titre seul, « Il a été convenu ce qui suit » en charnière de préambule, et une clôture d'acte (« En foi de quoi… ») au lieu d'une ligne de métadonnées. **Aucune date dans le texte** : *une date dans un texte scellé avant sa signature serait une date inventée.* ⚠️ **Le 2026-09 est figé à son tour**, empreinte verrouillée, après une journée d'existence. Pourquoi émettre plutôt que corriger, alors que personne ne l'a sans doute signé ? *Parce que « sans doute » ne se vérifie pas depuis un poste de développement : émettre ne coûte qu'une fonction morte, corriger à l'aveugle coûte le contrat de quelqu'un.* 📌 **Filigrane « PROJET » sur CHAQUE page d'un contrat non signé** — *une page 2 photocopiée seule ne dit plus d'où elle vient* — et absent dès qu'il est signé. ⚠️ **Écarté : « Fait à Brazzaville »**, que j'avais moi-même proposé. La formule est celle d'un acte signé de la main, en un lieu ; ici le praticien signe d'où il veut, et le siège d'ULAMU n'est établi nulle part dans ce projet. *Écrire un lieu qu'on ne connaît pas sur un acte, c'est inventer une mention que quelqu'un opposera un jour.* Écarté aussi : une case « Pour la Plateforme » — *une case de signature vide pour une partie qui ne signe pas fabrique une apparence.* ⚠️ **Une faute est passée sous le filet** : remettre l'ancienne détection de clôture, qui range le « En foi de quoi » du nouveau modèle dans le dernier article — l'acte se terminant alors au milieu de la loi applicable. **Aucun corps d'essai n'employait la nouvelle formule** : *un filet n'éprouve que les textes qu'on lui donne à lire.* Cas ajouté, puis **8 / 8**. 📌 **Quatre ancres reprises en conscience**, dont une **renversée** : le cas « met la commission en évidence, hors du corps » gardait exactement ce que le porteur dénonçait — il garde désormais son absence. **API 753 ✓ · web 1214 ✓ · types propres · lint 0 · 8 fautes injectées, 8 attrapées.** ⚠️ **Une réédition de plus sera nécessaire** : Armel porte le modèle 2026-09, le courant est 2026-09.2 — l'écran d'administration proposera le bouton. | ⏸ en attente | ⏸ |
| **146** | **La progression n'atteignait jamais la fin, et les numéros de version ne servaient à personne** — 16/09, **deux demandes du porteur**. ⚠️ **« Article 9 sur 11 » alors qu'on est en bas.** Mesuré en production : la zone de lecture fait 285 px pour 1 445 px de contenu — 1 160 px de défilement — et le onzième article commence à **1 313 px**. Ma règle demandait « quel article a franchi le HAUT de la fenêtre » : *les derniers n'y arrivent jamais, il n'y a plus rien en dessous pour les pousser vers le haut.* > **Mesurer une progression à ce qui a dépassé le haut de l'écran, c'est ne jamais pouvoir atteindre la fin.** 📌 Le calcul sort en fonction pure (`articleCourant`) — *la MESURE des positions demande un vrai moteur de rendu, le CALCUL non* — et les cas portent la géométrie réelle du 16/09. ⚠️ **Et j'y avais glissé une précaution morte** : une garantie « arrivé en bas, on est au dernier », avec une hauteur totale et une tolérance. L'injection l'a montrée inatteignable — au maximum de défilement la fenêtre atteint la fin du contenu, donc le dernier article y est forcément. *Du code défensif que rien ne peut déclencher ne protège de rien ; il fait seulement croire qu'on est protégé.* **Deuxième fois en dix chantiers** (voir 137) : retirée, deux paramètres avec. 📌 **Plus aucun numéro de version à l'écran** — « Contrat soignant ULAMU · version 2 », « Version 1 · signée le… », « Version 2 · non signée ». *Un numéro de version ne dit à personne ce qui a changé ni ce que ça coûte.* Les deux encadrés de comparaison cèdent la place à **une bulle** : ce qui a changé, ce que ça coûte, et le taux « de X % à Y % » uniquement s'il bouge. ⚠️ **« Partir sur le nouveau ou rester sur l'ancien » : ce choix n'existe pas.** Sans signer la version courante, on n'apparaît plus dans l'annuaire (RM-03-01). *Offrir un choix qu'on ne peut pas honorer est pire que de n'en offrir aucun.* Ce qui existe, et qui manquait : **relire et emporter ce qu'on avait accepté**. Le serveur sert désormais le texte du dernier contrat SIGNÉ, avec son sceau vérifié comme celui du courant — *servir un ancien contrat sans vérifier son empreinte reviendrait à dire « voici ce que vous aviez signé » sans en être sûr* — et l'écran l'ouvre dans un tiroir, ou l'imprime. > **Un contrat qu'on a signé et qu'on ne peut plus lire n'est pas un contrat.** 📌 **La relecture d'une version est écrite une fois** (`relireVersion`) : la version courante et la dernière signée suivent exactement la même règle — *une règle recopiée à deux endroits finit par diverger.* Ancre du 133 déplacée en conséquence : elle garde maintenant les deux d'un coup. ⚠️ **Écarté : lister les articles modifiés.** Comparer deux textes scellés automatiquement, c'est une lecture automatique d'un texte juridique : *si elle se trompe, elle rassure à tort.* Décision du porteur. ⚠️ **Une promesse du filet de refonte est tombée sur un retour à la ligne** : la phrase était intacte, le formatage l'avait coupée en deux. *Un filet qui exige une espace exacte accuse le formateur, pas celui qui aurait retiré la promesse.* ⚠️ **ET LE DÉPLOIEMENT A ÉCHOUÉ — par ma faute, et j'ai mis dix minutes à le voir.** Le web est resté sur le build précédent : la compilation refusait un objet `lastSigned` d'un test, resté incomplet. **Je vérifiais le typage avec `tsc --noEmit`, alors que la construction utilise `tsc -b`** — les deux ne regardent pas les mêmes fichiers. > **Vérifier avec une commande qui n'est pas celle qui construit, c'est vérifier autre chose.** 📌 Désormais : `npm run build` avant chaque commit, côté web ET côté API. *Le seul contrôle qui compte est celui que la machine de déploiement exécutera.* 📌 **Repéré en mesurant** : l'API avait redémarré en deux minutes, le paquet web n'avait pas bougé en dix. *Un déploiement qui échoue ne prévient personne : il laisse l'ancien en place, et tout a l'air normal.* **API 754 ✓ · web 1222 ✓ · build web et API vérifiés · lint 0 · 8 fautes injectées, 8 attrapées.** | ⏸ en attente | ⏸ |
| **147** | **Le filigrane porte la marque, pas seulement le mot** — 16/09, demande du porteur (« le filigrane doit être le texte ET LE LOGO ULAMU »). 📌 Un filigrane porte deux choses : **ce que vaut la feuille** (un projet) et **de qui elle vient**. Le mot seul disait la première ; la marque dit la seconde, et c'est elle qu'on reconnaît de loin sur une photocopie. 📌 L'opacité est portée par le contenant, pas par une couleur : *deux pâleurs réglées séparément finissent par se désaccorder.* ⚠️ **Rappel du contexte** : le porteur voyait encore « 0 % lu » et « Version 2 — modèle 2026-09 » — non pas des défauts restants, mais **un push qui avait échoué** (« Could not resolve host » — une coupure réseau, rattrapée ensuite) et **une réédition de contrat pas encore faite**. *Un correctif non déployé ressemble exactement à un correctif raté.* **web 1222 ✓ · build web et API vérifiés · lint 0 · 2 fautes injectées, 2 attrapées.** | ⏸ en attente | ⏸ |
...
*12/09/2026 — retirer une fonctionnalité coûte plus cher que l'ajouter, et pas là où on croit.*

#### Ce qu'on retire, et ce qu'on garde

Le patient remplissait deux champs avant d'entrer dans la conversation. Il entre maintenant
directement, et décrit son motif comme il parle — en écrivant, en dictant, en photographiant.

> **Demander les mêmes mots deux fois — une fois dans un formulaire, une fois dans la conversation —
> était le vrai coût de cet écran.**

📌 **Les données déjà transmises ne sont pas détruites.** La table reste, avec les symptômes des
consultations passées. Plus rien ne les lit ni ne les écrit ; elles restent atteignables en base si
une obligation les réclame.

> **Retirer une fonctionnalité, c'est fermer une porte — pas brûler ce qu'il y a derrière.**

#### Ce qu'une suppression emporte sans qu'on y pense

La pré-consultation ne portait pas que deux champs. Elle portait **le nom de la consultation** : le
chantier 76 titrait l'écran par le motif du patient, précisément pour qu'un soignant qui ouvre trois
séances dans l'après-midi ne voie pas trois onglets identiques.

> **Ce que le chantier 76 avait gagné n'est pas perdu : il avait gagné que l'écran se NOMME.** La
> matière a changé — c'est la date, maintenant — l'exigence non.

*Une fonctionnalité qu'on retire emporte ses écrans, pas ses exigences.* Chaque fois qu'un test est
tombé, la question n'était pas « faut-il le supprimer ? » mais « que défendait-il, et qui le défend
désormais ? ».

#### ⚠️ Douze tests tombés, et aucun à jeter

Un seul défendait la pré-consultation elle-même. **Les onze autres s'y ancraient pour vérifier tout
autre chose** : que les flèches du rail changent d'onglet, que l'échéance du compte-rendu reste
visible, que le rail ne reste pas sur un onglet disparu.

> **Un test qui perd son ancre ne perd pas son sujet.**

C'est le vrai coût d'une suppression, et il ne se voit pas dans le diff : il se voit dans le nombre
de fichiers qu'on doit relire pour comprendre ce que chacun protégeait.

#### ⚠️ Un remplacement en masse peut inverser un test

En réancrant, j'ai remplacé deux noms d'onglets par le même. Le test des flèches vérifiait alors
qu'une flèche droite ne change **rien** — il passait, et il affirmait le contraire de ce qu'il
défend.

> **Un remplacement en masse ne lit pas ; il substitue.** Dans un test, la valeur avant et la valeur
> après ne jouent pas le même rôle, et les confondre transforme une vérification en tautologie.

#### ⚠️ Absente et abîmée ne sont pas le même cas

Le titre retombe sur le mot générique quand la date manque. Mon test posait une date **vide** — qui
passe par la première garde. Une date **abîmée** passe au travers et ressort en « Consultation du
Invalid Date ».

> **La garde qu'on n'a pas visitée est celle qui cède.** C'est une faute injectée qui l'a montré, pas
> une relecture.
...
*12/09/2026 — le web était le seul à ne pas avoir ce que tout le monde avait.*

#### Deux boutons pour un seul geste possible

Le composeur du web portait un micro **et** une flèche d'envoi, côte à côte, en permanence. L'un des
deux était toujours éteint : la flèche tant que le champ est vide, le micro dès qu'on écrit.

> **Ce qu'on veut faire est déjà écrit dans le champ.** Demander de choisir entre deux commandes
> quand une seule est possible, c'est poser une question dont on connaît la réponse.

Le porteur l'a repéré dans la messagerie de CMS et l'a demandé. 📌 **Et le mobile d'ULAMU l'avait
déjà** — `draft.trim() || editMsg ? envoi : micro`, exactement le même motif. *Personne ne l'avait
vu, parce que les deux boutons du web marchaient : un défaut d'ergonomie ne casse rien, il fatigue.*

Trois états, et l'ordre compte : en retouche la **coche** l'emporte toujours ; champ écrit, la
**flèche** ; champ vide, le **micro** — qui n'est pas un `submit`, sans quoi il expédierait le
formulaire vide.

#### Nommer ce qu'on propose

Un sélecteur de fichiers **filtre selon ce qu'on lui annonce**. Un champ unique « tout accepter »
ferait remonter n'importe quoi pour le refuser ensuite. Trois champs, trois filtres, un menu qui les
nomme.

> **Choisir « Document » et voir ses photos est une promesse trahie avant même d'avoir cliqué.**

#### ⚠️ Une vidéo trop lourde n'est pas refusée

La règle paraît fausse et elle est juste. Le stockage plafonne à 8 Mo ; une vidéo de téléphone les
dépasse en quelques secondes. Si on la refuse au moment où elle est choisie, on la refuse **avant**
d'avoir pu proposer de la rogner.

> **Un refus qui précède le remède n'est pas une protection, c'est une porte fermée.**

Le contrôle de poids se fera donc sur l'EXTRAIT, juste avant l'envoi. Une image lourde, elle, reste
refusée tout de suite : rien à l'écran ne peut la sauver.

#### ⚠️ Trois filtres corrects peuvent pendre au même fil

Le premier test vérifiait que les trois sélecteurs portaient bien leurs filtres. La faute injectée —
faire ouvrir le sélecteur de photos par la ligne « Document » — **n'a réveillé personne**.

> **Vérifier que les bons outils existent ne dit rien de celui que le bouton attrape.** L'écran
> dirait vrai et le geste, non — ce qui est pire qu'un écran qui se trompe, parce qu'on ne le
> soupçonne pas.

Le second test note QUEL champ reçoit le clic. Il détecte la faute.
