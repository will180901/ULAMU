...
| 4 | **`SECRETBOX_KEY`** | Si la variable n'est pas renseignée sur Render, le code utilise une clé de repli **écrite en clair dans les sources**. Le chiffrement des messages, médias et secrets 2FA ne protégerait alors plus rien. À confirmer comme réellement définie. |
