...
**Ce qui reste — 7 lignes, et AUCUNE n'est du code** : cinq gestes appartiennent au porteur (changer
son mot de passe, suspendre les comptes de démonstration, sauvegarder `SECRETBOX_KEY`, lancer le
recalcul des indicateurs, et la n°20 qui dépend de la première), un seul arbitrage reste — le modèle
