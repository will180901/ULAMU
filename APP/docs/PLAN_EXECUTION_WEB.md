...
| 2 | A2 — Inscription (5 étapes, indicateur, consentement CGU) | **codé** | *en attente de test* |
| 3 | A3 — Mot de passe oublié (+ voie email, ferme un risque d'enfermement) | **codé** | *en attente de test* |
