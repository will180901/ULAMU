...
describe("Chantier 4 — ordonnance → recherche → dévoilement → délivrance (M09/M11/M12)", () => {
  ...
  beforeAll(async () => {
    ...
    patientId = (await m01.registerPatient({
      ...
      firstName: "Mireille", lastName: "Nkounkou", birthDate: "1994-03-15", sex: "F", district: DISTRICT, acceptTerms: true, client: "mobile",
    })).accountId;
    ...
    patient2Id = (await m01.registerPatient({
      ...
      firstName: "Gaston", lastName: "Mabiala", birthDate: "1968-01-10", sex: "M", district: DISTRICT, acceptTerms: true, client: "mobile",
    })).accountId;
